...
create table
  "Country" (
    Id bigint primary key generated always as identity,
    RegionId int null references "Region" (Id),
    SubRegionId int null references "SubRegion" (Id) on delete cascade on update cascade,
    Name varchar(50) not null,
...
create table
  "State" (
    Id bigint primary key generated always as identity,
    CountryId int not null references "Country" (Id) on delete cascade on update cascade,
